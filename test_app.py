...
class PeoplesAcademyTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # change your token here, either instructor or student..
    ...
    def test_get_courses_success(self):
        res = self.client().get('/api/courses', headers=self.token)
    ...
    def test_get_courses_failure(self):
        res = self.client().get('/api/coooourse', headers=self.token)
        data = json.loads(res.data)
    ...
    def test_get_course_index_success(self):
        res = self.client().get('/api/course/2', headers=self.token)
        data = json.loads(res.data)
    ...
    def test_get_courses_index_failure(self):
        res = self.client().get('/api/course/999', headers=self.token)
        data = json.loads(res.data)
    ...
    def test_get_instructor_success(self):
        res = self.client().get('/api/instructor', headers=self.token)
        data = json.loads(res.data)
    ...
    def test_get_instructor_failure(self):
        res = self.client().get('/api/instructooor', headers=self.token)
        data = json.loads(res.data)
    ...
    def test_get_instructor_index_success(self):
        res = self.client().get('/api/instructor/2', headers=self.token)
        data = json.loads(res.data)
    ...
    def test_get_instructor_index_failure(self):
        res = self.client().get('/api/instructor/999', headers=self.token)
        data = json.loads(res.data)
    ...
    def test_delete_course_success(self):
        res = self.client().delete('/api/course/2', headers=self.token)
        data = json.loads(res.data)
        self.assertEqual(data['success'], True)
        self.assertEqual(res.status_code, 200)

    def test_delete_course_failure(self):
        res = self.client().delete('/api/course/999', headers=self.token)
        data = json.loads(res.data)
        self.assertEqual(data['success'], False)
        self.assertEqual(res.status_code, 404)

    def test_delete_instructor_success(self):
        res = self.client().delete('/api/instructor/2', headers=self.token)
        data = json.loads(res.data)
        self.assertEqual(data['success'], True)
        self.assertEqual(res.status_code, 200)

    def test_delete_instructor_failure(self):
        res = self.client().delete('/api/instructor/999', headers=self.token)
        data = json.loads(res.data)
        self.assertEqual(data['success'], False)
        self.assertEqual(res.status_code, 404)
